...
--------------------------------------------------------------------------------
-- file_checksum: E425ECEC76A6D28524442946078EEBE13391E8B200B477FDA25B5E8CE7BB9BBE
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(394499196726760104)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74085212431359127)
,p_plug_template_id=>wwv_flow_imp.id(394499196726760104)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74085679042359127)
,p_plug_template_id=>wwv_flow_imp.id(394499196726760104)
,p_name=>'Tabs'
