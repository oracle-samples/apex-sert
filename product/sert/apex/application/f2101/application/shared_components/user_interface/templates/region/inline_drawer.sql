...
--------------------------------------------------------------------------------
-- file_checksum: 2CED445CCD4D15D93DF096718D8820C426FB799C89E150E00257427FA16914C0
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(394469604372760088)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74008692521359167)
,p_plug_template_id=>wwv_flow_imp.id(394469604372760088)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74009152023359167)
,p_plug_template_id=>wwv_flow_imp.id(394469604372760088)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74009749176359167)
,p_plug_template_id=>wwv_flow_imp.id(394469604372760088)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74010173903359167)
,p_plug_template_id=>wwv_flow_imp.id(394469604372760088)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74010732388359167)
,p_plug_template_id=>wwv_flow_imp.id(394469604372760088)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74011189324359167)
,p_plug_template_id=>wwv_flow_imp.id(394469604372760088)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74011717895359166)
,p_plug_template_id=>wwv_flow_imp.id(394469604372760088)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74012244992359166)
,p_plug_template_id=>wwv_flow_imp.id(394469604372760088)
,p_name=>'Sub Regions'
