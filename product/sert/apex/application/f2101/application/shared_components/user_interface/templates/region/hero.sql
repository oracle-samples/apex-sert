...
--------------------------------------------------------------------------------
-- file_checksum: B76684115A1292DBB94D821E08113DF8AA78585933AAAEA47D2F68F288CD18D6
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(394456121008760080)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73974192619359186)
,p_plug_template_id=>wwv_flow_imp.id(394456121008760080)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73974695028359186)
,p_plug_template_id=>wwv_flow_imp.id(394456121008760080)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73975212128359186)
,p_plug_template_id=>wwv_flow_imp.id(394456121008760080)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73975725465359185)
,p_plug_template_id=>wwv_flow_imp.id(394456121008760080)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73976245035359185)
,p_plug_template_id=>wwv_flow_imp.id(394456121008760080)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
