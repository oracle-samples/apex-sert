-- file_checksum: C79873D98FFD2FBD934994A72DCBE040402BAE3D20144FE4FE76375E2D7B79C9
-------------------------------------------------------------------------------
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(394441712109760072)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73938374553359206)
,p_plug_template_id=>wwv_flow_imp.id(394441712109760072)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73938871965359206)
,p_plug_template_id=>wwv_flow_imp.id(394441712109760072)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73939376746359206)
,p_plug_template_id=>wwv_flow_imp.id(394441712109760072)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73939928579359205)
,p_plug_template_id=>wwv_flow_imp.id(394441712109760072)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73940410284359205)
,p_plug_template_id=>wwv_flow_imp.id(394441712109760072)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73940916451359205)
,p_plug_template_id=>wwv_flow_imp.id(394441712109760072)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73941411998359205)
,p_plug_template_id=>wwv_flow_imp.id(394441712109760072)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73941949368359205)
,p_plug_template_id=>wwv_flow_imp.id(394441712109760072)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73942372179359204)
,p_plug_template_id=>wwv_flow_imp.id(394441712109760072)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73942944521359204)
,p_plug_template_id=>wwv_flow_imp.id(394441712109760072)
,p_name=>'Sub Regions'
