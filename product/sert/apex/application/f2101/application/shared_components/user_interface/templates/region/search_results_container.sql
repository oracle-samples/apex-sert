...
--------------------------------------------------------------------------------
-- file_checksum: 9CB72B53F6FBA2CA1F74B80CE77731F70AAD1C2B203024DB01F9C3C1D5CB6ABD
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(394486709960760097)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74051096379359146)
,p_plug_template_id=>wwv_flow_imp.id(394486709960760097)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74051590652359145)
,p_plug_template_id=>wwv_flow_imp.id(394486709960760097)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74052113997359145)
,p_plug_template_id=>wwv_flow_imp.id(394486709960760097)
,p_name=>'Sub Regions'
