-- file_checksum: 9293041F6A2C609ED42228721140F5D0E170258C87DC68ABCD26C6AB8A001C47
-------------------------------------------------------------------------------
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(394592821031760383)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2001516957400430631)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2001516402388430630)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1744624338658157117)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74280553307358933)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74281059506358933)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74281642393358933)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74282126733358932)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74282551874358932)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74283054111358931)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74283551648358931)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(74282551874358932)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2001516957400430631)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74284063449358930)
,p_plugin_attribute_id=>wwv_flow_imp.id(74283551648358931)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74284748584358930)
,p_plugin_attribute_id=>wwv_flow_imp.id(74283551648358931)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74285337553358927)
,p_plugin_attribute_id=>wwv_flow_imp.id(74283551648358931)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74285862623358927)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(74283551648358931)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74286418124358926)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74286904185358926)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74287431732358925)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74287948377358925)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74288427324358924)
,p_plugin_attribute_id=>wwv_flow_imp.id(74287948377358925)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74288979192358924)
,p_plugin_attribute_id=>wwv_flow_imp.id(74287948377358925)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74289562462358923)
,p_plugin_attribute_id=>wwv_flow_imp.id(74287948377358925)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74290185455358923)
,p_plugin_attribute_id=>wwv_flow_imp.id(74287948377358925)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74290838517358922)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(74283054111358931)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2001516402388430630)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74291259664358922)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74291766453358921)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74292279169358921)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74292811437358921)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74293312621358920)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74293816394358920)
,p_plugin_attribute_id=>wwv_flow_imp.id(74293312621358920)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74294400777358919)
,p_plugin_attribute_id=>wwv_flow_imp.id(74293312621358920)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74294974369358919)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74295544461358918)
,p_plugin_attribute_id=>wwv_flow_imp.id(74294974369358919)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74296079533358918)
,p_plugin_attribute_id=>wwv_flow_imp.id(74294974369358919)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74296740472358917)
,p_plugin_attribute_id=>wwv_flow_imp.id(74294974369358919)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74297319767358917)
,p_plugin_attribute_id=>wwv_flow_imp.id(74294974369358919)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74297925446358916)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74298419254358916)
,p_plugin_attribute_id=>wwv_flow_imp.id(74297925446358916)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74299024122358915)
,p_plugin_attribute_id=>wwv_flow_imp.id(74297925446358916)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74299561621358915)
,p_plugin_attribute_id=>wwv_flow_imp.id(74297925446358916)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74300174068358914)
,p_plugin_attribute_id=>wwv_flow_imp.id(74297925446358916)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74300820393358914)
,p_plugin_attribute_id=>wwv_flow_imp.id(74297925446358916)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74301384523358913)
,p_plugin_attribute_id=>wwv_flow_imp.id(74297925446358916)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74301998622358913)
,p_plugin_attribute_id=>wwv_flow_imp.id(74297925446358916)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74302552389358913)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74303124976358912)
,p_plugin_attribute_id=>wwv_flow_imp.id(74302552389358913)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74303700782358911)
,p_plugin_attribute_id=>wwv_flow_imp.id(74302552389358913)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74304255513358911)
,p_plugin_attribute_id=>wwv_flow_imp.id(74302552389358913)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74304873172358910)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74305369486358910)
,p_plugin_attribute_id=>wwv_flow_imp.id(74304873172358910)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74305964049358909)
,p_plugin_attribute_id=>wwv_flow_imp.id(74304873172358910)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74306565675358909)
,p_plugin_attribute_id=>wwv_flow_imp.id(74304873172358910)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74307220408358909)
,p_plugin_attribute_id=>wwv_flow_imp.id(74304873172358910)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74307763833358908)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74308257765358908)
,p_plugin_attribute_id=>wwv_flow_imp.id(74307763833358908)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74308868539358907)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74309383960358906)
,p_plugin_attribute_id=>wwv_flow_imp.id(74308868539358907)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74310000629358905)
,p_plugin_attribute_id=>wwv_flow_imp.id(74308868539358907)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74310615921358905)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74311053535358904)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74311601523358904)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(1744624338658157117)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74312052788358903)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74312636353358903)
,p_plugin_attribute_id=>wwv_flow_imp.id(74312052788358903)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74313240693358902)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74313700644358902)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2203044511521653703)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2203045771041657851)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1906092996625895273)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2189450882847246970)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2190130183577330074)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2203042576454608717)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2203043909844622574)
,p_plugin_id=>wwv_flow_imp.id(394592821031760383)
