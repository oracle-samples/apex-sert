...
--------------------------------------------------------------------------------
-- file_checksum: 58D554FC5D84FCB02F94916FF04E9F9836789AFD02BF1400CAABFC98E30CC2CC
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(394582493852760348)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1874147745819390675)
,p_plugin_id=>wwv_flow_imp.id(394582493852760348)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74262994004358958)
,p_plugin_id=>wwv_flow_imp.id(394582493852760348)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74263491390358957)
,p_plugin_id=>wwv_flow_imp.id(394582493852760348)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74263999163358957)
,p_plugin_id=>wwv_flow_imp.id(394582493852760348)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74264508084358956)
,p_plugin_id=>wwv_flow_imp.id(394582493852760348)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74265008276358956)
,p_plugin_id=>wwv_flow_imp.id(394582493852760348)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(74272191262358950)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1874147745819390675)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74265526931358956)
,p_plugin_attribute_id=>wwv_flow_imp.id(74265008276358956)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74266078697358955)
,p_plugin_attribute_id=>wwv_flow_imp.id(74265008276358956)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74266709213358955)
,p_plugin_attribute_id=>wwv_flow_imp.id(74265008276358956)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74267317415358954)
,p_plugin_id=>wwv_flow_imp.id(394582493852760348)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(74265008276358956)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74267769323358954)
,p_plugin_id=>wwv_flow_imp.id(394582493852760348)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74268346691358953)
,p_plugin_id=>wwv_flow_imp.id(394582493852760348)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74268791550358953)
,p_plugin_id=>wwv_flow_imp.id(394582493852760348)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74269308134358952)
,p_plugin_id=>wwv_flow_imp.id(394582493852760348)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74269783387358952)
,p_plugin_attribute_id=>wwv_flow_imp.id(74269308134358952)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74270392234358951)
,p_plugin_attribute_id=>wwv_flow_imp.id(74269308134358952)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74270960498358951)
,p_plugin_attribute_id=>wwv_flow_imp.id(74269308134358952)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74271576092358950)
,p_plugin_attribute_id=>wwv_flow_imp.id(74269308134358952)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74272191262358950)
,p_plugin_id=>wwv_flow_imp.id(394582493852760348)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74272728779358949)
,p_plugin_id=>wwv_flow_imp.id(394582493852760348)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74273172567358949)
,p_plugin_id=>wwv_flow_imp.id(394582493852760348)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74273669095358948)
,p_plugin_attribute_id=>wwv_flow_imp.id(74273172567358949)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74274281394358948)
,p_plugin_attribute_id=>wwv_flow_imp.id(74273172567358949)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74274944169358948)
,p_plugin_id=>wwv_flow_imp.id(394582493852760348)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2194600676767893570)
,p_plugin_id=>wwv_flow_imp.id(394582493852760348)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2194600085262886113)
,p_plugin_id=>wwv_flow_imp.id(394582493852760348)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2194655708932867992)
,p_plugin_id=>wwv_flow_imp.id(394582493852760348)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2194807926645738763)
,p_plugin_id=>wwv_flow_imp.id(394582493852760348)
