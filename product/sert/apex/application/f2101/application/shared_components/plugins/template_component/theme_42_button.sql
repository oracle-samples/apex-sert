-- file_checksum: 9E747193D9EE54FDBFA81267ABC87A836A21CCA9ACA47E838A1C5C956CA16203
-------------------------------------------------------------------------------
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(394579855964760339)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74258180900358966)
,p_plugin_id=>wwv_flow_imp.id(394579855964760339)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74258690585358966)
,p_plugin_id=>wwv_flow_imp.id(394579855964760339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74259239784358965)
,p_plugin_id=>wwv_flow_imp.id(394579855964760339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74259712373358965)
,p_plugin_id=>wwv_flow_imp.id(394579855964760339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74260200326358964)
,p_plugin_id=>wwv_flow_imp.id(394579855964760339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74260721844358964)
,p_plugin_id=>wwv_flow_imp.id(394579855964760339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74261201028358964)
,p_plugin_id=>wwv_flow_imp.id(394579855964760339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74261734001358963)
,p_plugin_id=>wwv_flow_imp.id(394579855964760339)
,p_attribute_scope=>'COMPONENT'
