-- file_checksum: 5030AA7689BCD45A7422067CC32A0BDDF72190836C6A6D2B880942CFB9C8B518
-------------------------------------------------------------------------------
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(394573732038760322)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74248604930358979)
,p_plugin_id=>wwv_flow_imp.id(394573732038760322)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74249123089358978)
,p_plugin_id=>wwv_flow_imp.id(394573732038760322)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74249570631358978)
,p_plugin_id=>wwv_flow_imp.id(394573732038760322)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74250083249358977)
,p_plugin_id=>wwv_flow_imp.id(394573732038760322)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74250560189358976)
,p_plugin_id=>wwv_flow_imp.id(394573732038760322)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74251135792358975)
,p_plugin_id=>wwv_flow_imp.id(394573732038760322)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74251591306358974)
,p_plugin_attribute_id=>wwv_flow_imp.id(74251135792358975)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74252167579358973)
,p_plugin_attribute_id=>wwv_flow_imp.id(74251135792358975)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74252819372358973)
,p_plugin_id=>wwv_flow_imp.id(394573732038760322)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74253272760358973)
,p_plugin_attribute_id=>wwv_flow_imp.id(74252819372358973)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74253935240358972)
,p_plugin_attribute_id=>wwv_flow_imp.id(74252819372358973)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74254522145358972)
,p_plugin_attribute_id=>wwv_flow_imp.id(74252819372358973)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74255053293358971)
,p_plugin_id=>wwv_flow_imp.id(394573732038760322)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74255622293358971)
,p_plugin_attribute_id=>wwv_flow_imp.id(74255053293358971)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74256167996358970)
,p_plugin_attribute_id=>wwv_flow_imp.id(74255053293358971)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74256834354358970)
,p_plugin_attribute_id=>wwv_flow_imp.id(74255053293358971)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1906055983315862513)
,p_plugin_id=>wwv_flow_imp.id(394573732038760322)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
