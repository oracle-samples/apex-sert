-- file_checksum: 18CE334337398F9CAA01BAE5F8CAD5B3A125AB5CBC69F0E5D8DF7B5F1D2B180B
-------------------------------------------------------------------------------
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(394564600750760237)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74234289087359002)
,p_plugin_id=>wwv_flow_imp.id(394564600750760237)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74234834497359001)
,p_plugin_attribute_id=>wwv_flow_imp.id(74234289087359002)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74235414568359000)
,p_plugin_attribute_id=>wwv_flow_imp.id(74234289087359002)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74235997907358999)
,p_plugin_attribute_id=>wwv_flow_imp.id(74234289087359002)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74236641712358998)
,p_plugin_id=>wwv_flow_imp.id(394564600750760237)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(74234289087359002)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74237091925358998)
,p_plugin_id=>wwv_flow_imp.id(394564600750760237)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74237599245358997)
,p_plugin_id=>wwv_flow_imp.id(394564600750760237)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74238110100358997)
,p_plugin_id=>wwv_flow_imp.id(394564600750760237)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74238630292358996)
,p_plugin_id=>wwv_flow_imp.id(394564600750760237)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74239062285358996)
,p_plugin_attribute_id=>wwv_flow_imp.id(74238630292358996)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74239695485358995)
,p_plugin_attribute_id=>wwv_flow_imp.id(74238630292358996)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74240308179358995)
,p_plugin_attribute_id=>wwv_flow_imp.id(74238630292358996)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74240945701358995)
,p_plugin_attribute_id=>wwv_flow_imp.id(74238630292358996)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74241456545358994)
,p_plugin_id=>wwv_flow_imp.id(394564600750760237)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74241978196358994)
,p_plugin_attribute_id=>wwv_flow_imp.id(74241456545358994)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74242635389358993)
,p_plugin_attribute_id=>wwv_flow_imp.id(74241456545358994)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74243246930358993)
,p_plugin_attribute_id=>wwv_flow_imp.id(74241456545358994)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74243814281358992)
,p_plugin_attribute_id=>wwv_flow_imp.id(74241456545358994)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74244449427358992)
,p_plugin_attribute_id=>wwv_flow_imp.id(74241456545358994)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74244987895358991)
,p_plugin_attribute_id=>wwv_flow_imp.id(74241456545358994)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74245569442358991)
,p_plugin_attribute_id=>wwv_flow_imp.id(74241456545358994)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74246180962358990)
,p_plugin_id=>wwv_flow_imp.id(394564600750760237)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2194615519220874003)
,p_plugin_id=>wwv_flow_imp.id(394564600750760237)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
