...
--------------------------------------------------------------------------------
-- file_checksum: A41E8D8C558CE236D74BFACCBB0669829113B4751669ED7E1BEC1A729A1328DF
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(512290590474949781)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2067522199360394022)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2067521644348394021)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1810629580618120508)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140285846163322325)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140286370473322323)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140286808648322323)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140287328523322322)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140287869595322322)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140288323577322322)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140288858518322321)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(140287869595322322)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2067522199360394022)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140289372032322321)
,p_plugin_attribute_id=>wwv_flow_imp.id(140288858518322321)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140289943005322320)
,p_plugin_attribute_id=>wwv_flow_imp.id(140288858518322321)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140290515394322320)
,p_plugin_attribute_id=>wwv_flow_imp.id(140288858518322321)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140291160332322319)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(140288858518322321)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140291596109322319)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140292122090322318)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140292636566322318)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140293142874322317)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140293655952322317)
,p_plugin_attribute_id=>wwv_flow_imp.id(140293142874322317)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140294194962322316)
,p_plugin_attribute_id=>wwv_flow_imp.id(140293142874322317)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140294805407322316)
,p_plugin_attribute_id=>wwv_flow_imp.id(140293142874322317)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140295418941322315)
,p_plugin_attribute_id=>wwv_flow_imp.id(140293142874322317)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140296062735322315)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(140288323577322322)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2067521644348394021)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140296547784322315)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140297058532322314)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140297554131322314)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140298070165322313)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140298565482322313)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140299070118322312)
,p_plugin_attribute_id=>wwv_flow_imp.id(140298565482322313)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140299653298322312)
,p_plugin_attribute_id=>wwv_flow_imp.id(140298565482322313)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140300246185322312)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140300698057322311)
,p_plugin_attribute_id=>wwv_flow_imp.id(140300246185322312)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140301372647322311)
,p_plugin_attribute_id=>wwv_flow_imp.id(140300246185322312)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140301950914322310)
,p_plugin_attribute_id=>wwv_flow_imp.id(140300246185322312)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140302550055322310)
,p_plugin_attribute_id=>wwv_flow_imp.id(140300246185322312)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140303135319322309)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140303620645322309)
,p_plugin_attribute_id=>wwv_flow_imp.id(140303135319322309)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140304277903322308)
,p_plugin_attribute_id=>wwv_flow_imp.id(140303135319322309)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140304787336322308)
,p_plugin_attribute_id=>wwv_flow_imp.id(140303135319322309)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140305464814322307)
,p_plugin_attribute_id=>wwv_flow_imp.id(140303135319322309)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140305995350322307)
,p_plugin_attribute_id=>wwv_flow_imp.id(140303135319322309)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140306617157322307)
,p_plugin_attribute_id=>wwv_flow_imp.id(140303135319322309)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140307225120322306)
,p_plugin_attribute_id=>wwv_flow_imp.id(140303135319322309)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140307848538322306)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140308302377322305)
,p_plugin_attribute_id=>wwv_flow_imp.id(140307848538322306)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140308974989322305)
,p_plugin_attribute_id=>wwv_flow_imp.id(140307848538322306)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140309505169322304)
,p_plugin_attribute_id=>wwv_flow_imp.id(140307848538322306)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140310106233322304)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140310588087322303)
,p_plugin_attribute_id=>wwv_flow_imp.id(140310106233322304)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140311211030322303)
,p_plugin_attribute_id=>wwv_flow_imp.id(140310106233322304)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140311847756322303)
,p_plugin_attribute_id=>wwv_flow_imp.id(140310106233322304)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140312404470322302)
,p_plugin_attribute_id=>wwv_flow_imp.id(140310106233322304)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140313048720322301)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140313548768322301)
,p_plugin_attribute_id=>wwv_flow_imp.id(140313048720322301)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140314141347322301)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140314659593322300)
,p_plugin_attribute_id=>wwv_flow_imp.id(140314141347322301)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140315257726322300)
,p_plugin_attribute_id=>wwv_flow_imp.id(140314141347322301)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140315789642322299)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140316303763322299)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140316789804322298)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(1810629580618120508)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140317319666322298)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140317812008322297)
,p_plugin_attribute_id=>wwv_flow_imp.id(140317319666322298)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140318424862322297)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140318915197322296)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2320742274669843097)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2320743534189847245)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2023790759774084667)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2307148645995436364)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2307827946725519468)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2320740339602798111)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2320741672992811968)
,p_plugin_id=>wwv_flow_imp.id(512290590474949781)
