-- file_checksum: CA011AB19516A445795BEE870B43DB67063473E9CAC62515AC87ECE77F1798D1
-------------------------------------------------------------------------------
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(468556131282671462)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(96541742594044089)
,p_plugin_id=>wwv_flow_imp.id(468556131282671462)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(96542182226044089)
,p_plugin_id=>wwv_flow_imp.id(468556131282671462)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(96542679070044089)
,p_plugin_id=>wwv_flow_imp.id(468556131282671462)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(96543172842044088)
,p_plugin_id=>wwv_flow_imp.id(468556131282671462)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(96543729559044088)
,p_plugin_id=>wwv_flow_imp.id(468556131282671462)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(96544230567044087)
,p_plugin_id=>wwv_flow_imp.id(468556131282671462)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(96544758060044087)
,p_plugin_id=>wwv_flow_imp.id(468556131282671462)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(96545221596044087)
,p_plugin_id=>wwv_flow_imp.id(468556131282671462)
,p_attribute_scope=>'COMPONENT'
