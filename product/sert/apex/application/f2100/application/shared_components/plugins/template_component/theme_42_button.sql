-- file_checksum: D1B5833E3CCD330F2895BB38DF58D062F4348AE862E7C4315E50CCB9DB1D40DF
-------------------------------------------------------------------------------
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(512277549143949725)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140263160455322352)
,p_plugin_id=>wwv_flow_imp.id(512277549143949725)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140263600087322352)
,p_plugin_id=>wwv_flow_imp.id(512277549143949725)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140264096931322352)
,p_plugin_id=>wwv_flow_imp.id(512277549143949725)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140264590703322351)
,p_plugin_id=>wwv_flow_imp.id(512277549143949725)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140265147420322351)
,p_plugin_id=>wwv_flow_imp.id(512277549143949725)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140265648428322350)
,p_plugin_id=>wwv_flow_imp.id(512277549143949725)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140266175921322350)
,p_plugin_id=>wwv_flow_imp.id(512277549143949725)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140266639457322350)
,p_plugin_id=>wwv_flow_imp.id(512277549143949725)
,p_attribute_scope=>'COMPONENT'
