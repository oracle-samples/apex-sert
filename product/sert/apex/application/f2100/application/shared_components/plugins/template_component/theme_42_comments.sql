-- file_checksum: 8E8BF92A41AF2CB201F34B760BB537DB3328F0526F74142D6CBB71DB4C05AC61
-------------------------------------------------------------------------------
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(468558922185671480)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1896431281672075800)
,p_plugin_id=>wwv_flow_imp.id(468558922185671480)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(96546477288044083)
,p_plugin_id=>wwv_flow_imp.id(468558922185671480)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(96546980256044082)
,p_plugin_id=>wwv_flow_imp.id(468558922185671480)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(96547495788044082)
,p_plugin_id=>wwv_flow_imp.id(468558922185671480)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(96548046042044081)
,p_plugin_id=>wwv_flow_imp.id(468558922185671480)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(96548511856044081)
,p_plugin_id=>wwv_flow_imp.id(468558922185671480)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(96555737091044075)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1896431281672075800)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(96548983293044081)
,p_plugin_attribute_id=>wwv_flow_imp.id(96548511856044081)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(96549573498044080)
,p_plugin_attribute_id=>wwv_flow_imp.id(96548511856044081)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(96550219757044080)
,p_plugin_attribute_id=>wwv_flow_imp.id(96548511856044081)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(96550832107044079)
,p_plugin_id=>wwv_flow_imp.id(468558922185671480)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(96548511856044081)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(96551289366044079)
,p_plugin_id=>wwv_flow_imp.id(468558922185671480)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(96551799979044078)
,p_plugin_id=>wwv_flow_imp.id(468558922185671480)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(96552300078044078)
,p_plugin_id=>wwv_flow_imp.id(468558922185671480)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(96552803497044078)
,p_plugin_id=>wwv_flow_imp.id(468558922185671480)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(96553308719044077)
,p_plugin_attribute_id=>wwv_flow_imp.id(96552803497044078)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(96553877415044077)
,p_plugin_attribute_id=>wwv_flow_imp.id(96552803497044078)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(96554475574044076)
,p_plugin_attribute_id=>wwv_flow_imp.id(96552803497044078)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(96555117097044076)
,p_plugin_attribute_id=>wwv_flow_imp.id(96552803497044078)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(96555737091044075)
,p_plugin_id=>wwv_flow_imp.id(468558922185671480)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(96556235675044075)
,p_plugin_id=>wwv_flow_imp.id(468558922185671480)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(96556685730044074)
,p_plugin_id=>wwv_flow_imp.id(468558922185671480)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(96557229761044074)
,p_plugin_attribute_id=>wwv_flow_imp.id(96556685730044074)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(96557821822044074)
,p_plugin_attribute_id=>wwv_flow_imp.id(96556685730044074)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(96558431662044073)
,p_plugin_id=>wwv_flow_imp.id(468558922185671480)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2268576986191804702)
,p_plugin_id=>wwv_flow_imp.id(468558922185671480)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2268576394686797245)
,p_plugin_id=>wwv_flow_imp.id(468558922185671480)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2268632018356779124)
,p_plugin_id=>wwv_flow_imp.id(468558922185671480)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2268784236069649895)
,p_plugin_id=>wwv_flow_imp.id(468558922185671480)
