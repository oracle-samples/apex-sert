...
--------------------------------------------------------------------------------
-- file_checksum: 678A175AF6314CF429A4FDDC0FBB2CD410B35AB8F8A1B2DF07AFA79EA71869CA
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(512280340046949743)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1940152699533354063)
,p_plugin_id=>wwv_flow_imp.id(512280340046949743)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140267895149322346)
,p_plugin_id=>wwv_flow_imp.id(512280340046949743)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140268398117322345)
,p_plugin_id=>wwv_flow_imp.id(512280340046949743)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140268913649322345)
,p_plugin_id=>wwv_flow_imp.id(512280340046949743)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140269463903322344)
,p_plugin_id=>wwv_flow_imp.id(512280340046949743)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140269929717322344)
,p_plugin_id=>wwv_flow_imp.id(512280340046949743)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(140277154952322338)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1940152699533354063)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140270401154322344)
,p_plugin_attribute_id=>wwv_flow_imp.id(140269929717322344)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140270991359322343)
,p_plugin_attribute_id=>wwv_flow_imp.id(140269929717322344)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140271637618322343)
,p_plugin_attribute_id=>wwv_flow_imp.id(140269929717322344)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140272249968322342)
,p_plugin_id=>wwv_flow_imp.id(512280340046949743)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(140269929717322344)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140272707227322342)
,p_plugin_id=>wwv_flow_imp.id(512280340046949743)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140273217840322341)
,p_plugin_id=>wwv_flow_imp.id(512280340046949743)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140273717939322341)
,p_plugin_id=>wwv_flow_imp.id(512280340046949743)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140274221358322341)
,p_plugin_id=>wwv_flow_imp.id(512280340046949743)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140274726580322340)
,p_plugin_attribute_id=>wwv_flow_imp.id(140274221358322341)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140275295276322340)
,p_plugin_attribute_id=>wwv_flow_imp.id(140274221358322341)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140275893435322339)
,p_plugin_attribute_id=>wwv_flow_imp.id(140274221358322341)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140276534958322339)
,p_plugin_attribute_id=>wwv_flow_imp.id(140274221358322341)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140277154952322338)
,p_plugin_id=>wwv_flow_imp.id(512280340046949743)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140277653536322338)
,p_plugin_id=>wwv_flow_imp.id(512280340046949743)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140278103591322337)
,p_plugin_id=>wwv_flow_imp.id(512280340046949743)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140278647622322337)
,p_plugin_attribute_id=>wwv_flow_imp.id(140278103591322337)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(140279239683322337)
,p_plugin_attribute_id=>wwv_flow_imp.id(140278103591322337)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(140279849523322336)
,p_plugin_id=>wwv_flow_imp.id(512280340046949743)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2312298404053082965)
,p_plugin_id=>wwv_flow_imp.id(512280340046949743)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2312297812548075508)
,p_plugin_id=>wwv_flow_imp.id(512280340046949743)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2312353436218057387)
,p_plugin_id=>wwv_flow_imp.id(512280340046949743)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2312505653930928158)
,p_plugin_id=>wwv_flow_imp.id(512280340046949743)
