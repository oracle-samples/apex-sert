...
begin
   ...
   end if; -- condition: length(l_string1) <= length(l_string2)

   return ( l_string1 = l_string2
            or ( l_string1 is null and l_string2 is null ) );
end match_string;
...
begin
   if ( match_string(p_string1, p_string2) ) then
      ...
      return 'N';
   end if; -- condition: match_string(p_string1, p_string2)
