...
--changeset mipotter:create_table_sert_core.eval_results_1721796133846 endDelimiter:; runOnChange:true runAlways:false rollbackEndDelimiter:;
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(1) from all_tables where owner = 'SERT_CORE' and table_name = 'EVAL_RESULTS';
...
--rollback drop table sert_core.eval_results;
