...
--changeset mipotter:create_view_sert_core.exception_cnt_v_1721804284728 endDelimiter:/ runOnChange:true runAlways:false rollbackEndDelimiter:/
...
select
  ...
  ,e.result
  ,e.current_value
  ,any_value(e.justification) as justification
