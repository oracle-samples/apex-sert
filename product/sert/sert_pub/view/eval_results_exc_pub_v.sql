...
--------------------------------------------------------------------------------
--changeset mipotter:create_view_sert_pub.eval_results_exc_pub_v endDelimiter:; runOnChange:true runAlways:false rollbackEndDelimiter:;
create or replace force view sert_pub.eval_results_exc_pub_v as
select  er.EVAL_RESULT_ID
       ...
       ,ep.exception_key
       ,ep.exception as exception_justification
       ,ep.reason as exception_reason
       ,case
