...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(23302509606218268)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1950540540709289963)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1950539985697289962)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23303873949218268)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23304353544218269)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23304867451218269)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23305366099218269)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23305849895218269)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23306310901218270)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23306867698218270)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(23305849895218269)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1950540540709289963)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23307305663218270)
,p_plugin_attribute_id=>wwv_flow_imp.id(23306867698218270)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23307890731218271)
,p_plugin_attribute_id=>wwv_flow_imp.id(23306867698218270)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23308514388218271)
,p_plugin_attribute_id=>wwv_flow_imp.id(23306867698218270)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23309094372218271)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(23306867698218270)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23309594704218271)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(23309094372218271)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23310133317218272)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23310616472218272)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23311135152218272)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23311603434218272)
,p_plugin_attribute_id=>wwv_flow_imp.id(23311135152218272)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23312205461218273)
,p_plugin_attribute_id=>wwv_flow_imp.id(23311135152218272)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23312790173218273)
,p_plugin_attribute_id=>wwv_flow_imp.id(23311135152218272)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23313392617218273)
,p_plugin_attribute_id=>wwv_flow_imp.id(23311135152218272)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23314019924218273)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(23306310901218270)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1950539985697289962)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23314524670218274)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23315073149218274)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23315557652218274)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23315998058218274)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23316550942218275)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23317049094218275)
,p_plugin_attribute_id=>wwv_flow_imp.id(23316550942218275)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23317604887218275)
,p_plugin_attribute_id=>wwv_flow_imp.id(23316550942218275)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23318279808218275)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23318717522218276)
,p_plugin_attribute_id=>wwv_flow_imp.id(23318279808218275)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23319369042218276)
,p_plugin_attribute_id=>wwv_flow_imp.id(23318279808218275)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23319952997218276)
,p_plugin_attribute_id=>wwv_flow_imp.id(23318279808218275)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23320535334218276)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23320988215218277)
,p_plugin_attribute_id=>wwv_flow_imp.id(23320535334218276)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23321680353218277)
,p_plugin_attribute_id=>wwv_flow_imp.id(23320535334218276)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23322219083218277)
,p_plugin_attribute_id=>wwv_flow_imp.id(23320535334218276)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23322820668218277)
,p_plugin_attribute_id=>wwv_flow_imp.id(23320535334218276)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23323463847218278)
,p_plugin_attribute_id=>wwv_flow_imp.id(23320535334218276)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23324052027218278)
,p_plugin_attribute_id=>wwv_flow_imp.id(23320535334218276)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23324676970218278)
,p_plugin_attribute_id=>wwv_flow_imp.id(23320535334218276)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23325236549218279)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23325769468218279)
,p_plugin_attribute_id=>wwv_flow_imp.id(23325236549218279)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23326311912218279)
,p_plugin_attribute_id=>wwv_flow_imp.id(23325236549218279)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23326959829218280)
,p_plugin_attribute_id=>wwv_flow_imp.id(23325236549218279)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23327511876218280)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23328062574218280)
,p_plugin_attribute_id=>wwv_flow_imp.id(23327511876218280)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23328638447218280)
,p_plugin_attribute_id=>wwv_flow_imp.id(23327511876218280)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23329205498218281)
,p_plugin_attribute_id=>wwv_flow_imp.id(23327511876218280)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23329801392218281)
,p_plugin_attribute_id=>wwv_flow_imp.id(23327511876218280)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23330483126218281)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1831754430925111577)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1831755690445115725)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1818160802250704844)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1818840102980787948)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1831752495858066591)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1831753829248080448)
,p_plugin_id=>wwv_flow_imp.id(23302509606218268)
