...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(23272031511218252)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23272555736218252)
,p_plugin_id=>wwv_flow_imp.id(23272031511218252)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23273065869218252)
,p_plugin_id=>wwv_flow_imp.id(23272031511218252)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23273518423218252)
,p_plugin_id=>wwv_flow_imp.id(23272031511218252)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23274069756218253)
,p_plugin_id=>wwv_flow_imp.id(23272031511218252)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23274558013218253)
,p_plugin_id=>wwv_flow_imp.id(23272031511218252)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23275041279218253)
,p_plugin_id=>wwv_flow_imp.id(23272031511218252)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23275521706218253)
,p_plugin_id=>wwv_flow_imp.id(23272031511218252)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23276018855218254)
,p_plugin_id=>wwv_flow_imp.id(23272031511218252)
,p_attribute_scope=>'COMPONENT'
