...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(23231719482218228)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23232211967218229)
,p_plugin_id=>wwv_flow_imp.id(23231719482218228)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23232718635218229)
,p_plugin_attribute_id=>wwv_flow_imp.id(23232211967218229)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23233364448218229)
,p_plugin_attribute_id=>wwv_flow_imp.id(23232211967218229)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23233976369218229)
,p_plugin_attribute_id=>wwv_flow_imp.id(23232211967218229)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23234540435218230)
,p_plugin_id=>wwv_flow_imp.id(23231719482218228)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(23232211967218229)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23235037086218230)
,p_plugin_id=>wwv_flow_imp.id(23231719482218228)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(23234540435218230)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23235528761218230)
,p_plugin_id=>wwv_flow_imp.id(23231719482218228)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23236072721218230)
,p_plugin_id=>wwv_flow_imp.id(23231719482218228)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23236555577218231)
,p_plugin_id=>wwv_flow_imp.id(23231719482218228)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23236993786218231)
,p_plugin_attribute_id=>wwv_flow_imp.id(23236555577218231)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23237637603218231)
,p_plugin_attribute_id=>wwv_flow_imp.id(23236555577218231)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23238268028218231)
,p_plugin_attribute_id=>wwv_flow_imp.id(23236555577218231)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23238787977218232)
,p_plugin_id=>wwv_flow_imp.id(23231719482218228)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23239362990218232)
,p_plugin_attribute_id=>wwv_flow_imp.id(23238787977218232)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23239886812218232)
,p_plugin_attribute_id=>wwv_flow_imp.id(23238787977218232)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23240564179218232)
,p_plugin_attribute_id=>wwv_flow_imp.id(23238787977218232)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23241095542218233)
,p_plugin_attribute_id=>wwv_flow_imp.id(23238787977218232)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23241740560218233)
,p_plugin_attribute_id=>wwv_flow_imp.id(23238787977218232)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23242357304218233)
,p_plugin_attribute_id=>wwv_flow_imp.id(23238787977218232)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23242892762218233)
,p_plugin_attribute_id=>wwv_flow_imp.id(23238787977218232)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23243499385218234)
,p_plugin_id=>wwv_flow_imp.id(23231719482218228)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1823282826401331980)
,p_plugin_id=>wwv_flow_imp.id(23231719482218228)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
