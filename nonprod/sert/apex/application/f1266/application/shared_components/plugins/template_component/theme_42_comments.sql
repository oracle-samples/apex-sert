...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(23255195039218243)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1823140868024249959)
,p_plugin_id=>wwv_flow_imp.id(23255195039218243)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23256183099218243)
,p_plugin_id=>wwv_flow_imp.id(23255195039218243)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23256611446218244)
,p_plugin_id=>wwv_flow_imp.id(23255195039218243)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23257121192218244)
,p_plugin_id=>wwv_flow_imp.id(23255195039218243)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23257608421218244)
,p_plugin_id=>wwv_flow_imp.id(23255195039218243)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23258157640218244)
,p_plugin_id=>wwv_flow_imp.id(23255195039218243)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(23265350953218248)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1823140868024249959)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23258630849218245)
,p_plugin_attribute_id=>wwv_flow_imp.id(23258157640218244)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23259185436218245)
,p_plugin_attribute_id=>wwv_flow_imp.id(23258157640218244)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23259843521218245)
,p_plugin_attribute_id=>wwv_flow_imp.id(23258157640218244)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23260427297218245)
,p_plugin_id=>wwv_flow_imp.id(23255195039218243)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(23258157640218244)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23260918117218246)
,p_plugin_id=>wwv_flow_imp.id(23255195039218243)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(23260427297218245)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23261408285218246)
,p_plugin_id=>wwv_flow_imp.id(23255195039218243)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23261889371218246)
,p_plugin_id=>wwv_flow_imp.id(23255195039218243)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23262428080218246)
,p_plugin_id=>wwv_flow_imp.id(23255195039218243)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23262941509218247)
,p_plugin_attribute_id=>wwv_flow_imp.id(23262428080218246)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23263547229218247)
,p_plugin_attribute_id=>wwv_flow_imp.id(23262428080218246)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23264115758218247)
,p_plugin_attribute_id=>wwv_flow_imp.id(23262428080218246)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23264728505218247)
,p_plugin_attribute_id=>wwv_flow_imp.id(23262428080218246)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23265350953218248)
,p_plugin_id=>wwv_flow_imp.id(23255195039218243)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23265799705218248)
,p_plugin_id=>wwv_flow_imp.id(23255195039218243)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23266303791218248)
,p_plugin_attribute_id=>wwv_flow_imp.id(23265799705218248)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23266886477218248)
,p_plugin_attribute_id=>wwv_flow_imp.id(23265799705218248)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23267542042218249)
,p_plugin_id=>wwv_flow_imp.id(23255195039218243)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1823273535457351462)
,p_plugin_id=>wwv_flow_imp.id(23255195039218243)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1823272943952344005)
,p_plugin_id=>wwv_flow_imp.id(23255195039218243)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1823328567622325884)
,p_plugin_id=>wwv_flow_imp.id(23255195039218243)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1823480785335196655)
,p_plugin_id=>wwv_flow_imp.id(23255195039218243)
