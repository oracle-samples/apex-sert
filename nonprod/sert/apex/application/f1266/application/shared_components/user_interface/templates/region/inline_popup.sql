...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(23066964817218114)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23067396226218114)
,p_plug_template_id=>wwv_flow_imp.id(23066964817218114)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23067931901218115)
,p_plug_template_id=>wwv_flow_imp.id(23066964817218114)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23068439272218115)
,p_plug_template_id=>wwv_flow_imp.id(23066964817218114)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23068942425218115)
,p_plug_template_id=>wwv_flow_imp.id(23066964817218114)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23069476387218115)
,p_plug_template_id=>wwv_flow_imp.id(23066964817218114)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23069915656218116)
,p_plug_template_id=>wwv_flow_imp.id(23066964817218114)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23070459927218116)
,p_plug_template_id=>wwv_flow_imp.id(23066964817218114)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23070956877218116)
,p_plug_template_id=>wwv_flow_imp.id(23066964817218114)
,p_name=>'Sub Regions'
