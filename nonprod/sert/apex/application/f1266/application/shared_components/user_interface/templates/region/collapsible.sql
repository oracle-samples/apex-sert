...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(43733702043394119)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22906032321218020)
,p_plug_template_id=>wwv_flow_imp.id(43733702043394119)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22906489665218020)
,p_plug_template_id=>wwv_flow_imp.id(43733702043394119)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22907045422218020)
,p_plug_template_id=>wwv_flow_imp.id(43733702043394119)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22907504152218020)
,p_plug_template_id=>wwv_flow_imp.id(43733702043394119)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22908010834218020)
,p_plug_template_id=>wwv_flow_imp.id(43733702043394119)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22908525929218021)
,p_plug_template_id=>wwv_flow_imp.id(43733702043394119)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22909064632218021)
,p_plug_template_id=>wwv_flow_imp.id(43733702043394119)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22909562951218021)
,p_plug_template_id=>wwv_flow_imp.id(43733702043394119)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22909988242218021)
,p_plug_template_id=>wwv_flow_imp.id(43733702043394119)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22910542998218021)
,p_plug_template_id=>wwv_flow_imp.id(43733702043394119)
,p_name=>'Sub Regions'
