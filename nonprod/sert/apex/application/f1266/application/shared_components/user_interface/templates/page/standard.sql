-- file_checksum: FF6D5BFC1CA2A70C9C578975E7CF3E237D42DE58B458353B613AE60F67215644
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(43741515325394135)
,p_theme_id=>42
,p_name=>'Standard'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22831118909217971)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22831631627217972)
,p_page_template_id=>wwv_flow_imp.id(43741515325394135)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22832135670217972)
,p_page_template_id=>wwv_flow_imp.id(43741515325394135)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22832619891217972)
,p_page_template_id=>wwv_flow_imp.id(43741515325394135)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22833143705217972)
,p_page_template_id=>wwv_flow_imp.id(43741515325394135)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22833646172217972)
,p_page_template_id=>wwv_flow_imp.id(43741515325394135)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22834149288217973)
,p_page_template_id=>wwv_flow_imp.id(43741515325394135)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22834669805217973)
,p_page_template_id=>wwv_flow_imp.id(43741515325394135)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22835090460217973)
,p_page_template_id=>wwv_flow_imp.id(43741515325394135)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22835642727217973)
,p_page_template_id=>wwv_flow_imp.id(43741515325394135)
