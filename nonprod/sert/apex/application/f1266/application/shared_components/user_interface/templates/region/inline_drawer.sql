...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(23049890527218106)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23050468907218106)
,p_plug_template_id=>wwv_flow_imp.id(23049890527218106)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23050960408218107)
,p_plug_template_id=>wwv_flow_imp.id(23049890527218106)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23051427544218107)
,p_plug_template_id=>wwv_flow_imp.id(23049890527218106)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23051946831218107)
,p_plug_template_id=>wwv_flow_imp.id(23049890527218106)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23052460676218107)
,p_plug_template_id=>wwv_flow_imp.id(23049890527218106)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23052898130218107)
,p_plug_template_id=>wwv_flow_imp.id(23049890527218106)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23053460656218108)
,p_plug_template_id=>wwv_flow_imp.id(23049890527218106)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23053965625218108)
,p_plug_template_id=>wwv_flow_imp.id(23049890527218106)
,p_name=>'Sub Regions'
