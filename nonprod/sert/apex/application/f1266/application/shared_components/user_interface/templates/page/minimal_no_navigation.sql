-- file_checksum: 7141466337554A3DCB3ECF86AE39D71047C643978E2ECDEED0C0BA3ACB0681AB
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(43743715019394140)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22808653842217961)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22809142913217961)
,p_page_template_id=>wwv_flow_imp.id(43743715019394140)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22809654450217961)
,p_page_template_id=>wwv_flow_imp.id(43743715019394140)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22810151366217961)
,p_page_template_id=>wwv_flow_imp.id(43743715019394140)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22810654335217961)
,p_page_template_id=>wwv_flow_imp.id(43743715019394140)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22811172175217962)
,p_page_template_id=>wwv_flow_imp.id(43743715019394140)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22811623230217962)
,p_page_template_id=>wwv_flow_imp.id(43743715019394140)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22812108504217962)
,p_page_template_id=>wwv_flow_imp.id(43743715019394140)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22812679588217962)
,p_page_template_id=>wwv_flow_imp.id(43743715019394140)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22813113470217962)
,p_page_template_id=>wwv_flow_imp.id(43743715019394140)
