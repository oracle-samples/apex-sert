...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(43738221882394125)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22863953053217996)
,p_plug_template_id=>wwv_flow_imp.id(43738221882394125)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22864402353217996)
,p_plug_template_id=>wwv_flow_imp.id(43738221882394125)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22864939945217996)
,p_plug_template_id=>wwv_flow_imp.id(43738221882394125)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22865418992217996)
,p_plug_template_id=>wwv_flow_imp.id(43738221882394125)
,p_name=>'Sub Regions'
