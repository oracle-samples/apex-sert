...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(43725177929394110)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23024704773218092)
,p_plug_template_id=>wwv_flow_imp.id(43725177929394110)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23025272458218092)
,p_plug_template_id=>wwv_flow_imp.id(43725177929394110)
,p_name=>'Tabs'
