...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(23080813131218121)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23081373874218121)
,p_plug_template_id=>wwv_flow_imp.id(23080813131218121)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23081864617218121)
,p_plug_template_id=>wwv_flow_imp.id(23080813131218121)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23082369154218121)
,p_plug_template_id=>wwv_flow_imp.id(23080813131218121)
,p_name=>'Button Start'
