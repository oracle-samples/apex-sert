...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(23057911485218110)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23058405259218110)
,p_plug_template_id=>wwv_flow_imp.id(23057911485218110)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23058967742218110)
,p_plug_template_id=>wwv_flow_imp.id(23057911485218110)
,p_name=>'Sub Regions'
