...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(43728883880394113)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22974046407218058)
,p_plug_template_id=>wwv_flow_imp.id(43728883880394113)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22974559134218058)
,p_plug_template_id=>wwv_flow_imp.id(43728883880394113)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22974997483218059)
,p_plug_template_id=>wwv_flow_imp.id(43728883880394113)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22975497990218059)
,p_plug_template_id=>wwv_flow_imp.id(43728883880394113)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22976041479218059)
,p_plug_template_id=>wwv_flow_imp.id(43728883880394113)
,p_name=>'Sub Regions'
