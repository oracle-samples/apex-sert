...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(43746848127394152)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22769799656217941)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22770304829217942)
,p_page_template_id=>wwv_flow_imp.id(43746848127394152)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22770833706217942)
,p_page_template_id=>wwv_flow_imp.id(43746848127394152)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22771343576217942)
,p_page_template_id=>wwv_flow_imp.id(43746848127394152)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22771811721217942)
,p_page_template_id=>wwv_flow_imp.id(43746848127394152)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22772304780217942)
,p_page_template_id=>wwv_flow_imp.id(43746848127394152)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22772795571217943)
,p_page_template_id=>wwv_flow_imp.id(43746848127394152)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22773309597217943)
,p_page_template_id=>wwv_flow_imp.id(43746848127394152)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22773829413217943)
,p_page_template_id=>wwv_flow_imp.id(43746848127394152)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22774310059217943)
,p_page_template_id=>wwv_flow_imp.id(43746848127394152)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22774837991217944)
,p_page_template_id=>wwv_flow_imp.id(43746848127394152)
