...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(23076581080218119)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23077009236218119)
,p_plug_template_id=>wwv_flow_imp.id(23076581080218119)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23077584891218119)
,p_plug_template_id=>wwv_flow_imp.id(23076581080218119)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23078039911218119)
,p_plug_template_id=>wwv_flow_imp.id(23076581080218119)
,p_name=>'Sub Regions'
