...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(43723611252394107)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23046001346218104)
,p_plug_template_id=>wwv_flow_imp.id(43723611252394107)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23046520508218104)
,p_plug_template_id=>wwv_flow_imp.id(43723611252394107)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23047045557218104)
,p_plug_template_id=>wwv_flow_imp.id(43723611252394107)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23047546678218104)
,p_plug_template_id=>wwv_flow_imp.id(43723611252394107)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23048080748218105)
,p_plug_template_id=>wwv_flow_imp.id(43723611252394107)
