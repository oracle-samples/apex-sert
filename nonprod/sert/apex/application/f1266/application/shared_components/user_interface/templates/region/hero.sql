...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(43730576674394117)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22951144214218046)
,p_plug_template_id=>wwv_flow_imp.id(43730576674394117)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22951611312218046)
,p_plug_template_id=>wwv_flow_imp.id(43730576674394117)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22952125353218046)
,p_plug_template_id=>wwv_flow_imp.id(43730576674394117)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22952660025218046)
,p_plug_template_id=>wwv_flow_imp.id(43730576674394117)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22953091582218047)
,p_plug_template_id=>wwv_flow_imp.id(43730576674394117)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
