-- file_checksum: D5C6DD79756EEC8F7F290A25778D378606A4727B226940A3946EF8B17D0EF70D
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(43728555921394113)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22979393701218061)
,p_plug_template_id=>wwv_flow_imp.id(43728555921394113)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22979972371218061)
,p_plug_template_id=>wwv_flow_imp.id(43728555921394113)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22980432937218062)
,p_plug_template_id=>wwv_flow_imp.id(43728555921394113)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22980971660218062)
,p_plug_template_id=>wwv_flow_imp.id(43728555921394113)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22981393122218062)
,p_plug_template_id=>wwv_flow_imp.id(43728555921394113)
,p_name=>'Sub Regions'
