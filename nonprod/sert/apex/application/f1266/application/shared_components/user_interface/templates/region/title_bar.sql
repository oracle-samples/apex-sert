...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(43724015402394110)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23033758910218097)
,p_plug_template_id=>wwv_flow_imp.id(43724015402394110)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23034283998218097)
,p_plug_template_id=>wwv_flow_imp.id(43724015402394110)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23034730444218098)
,p_plug_template_id=>wwv_flow_imp.id(43724015402394110)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23035258903218098)
,p_plug_template_id=>wwv_flow_imp.id(43724015402394110)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23035758307218098)
,p_plug_template_id=>wwv_flow_imp.id(43724015402394110)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23036267225218098)
,p_plug_template_id=>wwv_flow_imp.id(43724015402394110)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23036771013218099)
,p_plug_template_id=>wwv_flow_imp.id(43724015402394110)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23037214252218099)
,p_plug_template_id=>wwv_flow_imp.id(43724015402394110)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23037761523218099)
,p_plug_template_id=>wwv_flow_imp.id(43724015402394110)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23038248993218099)
,p_plug_template_id=>wwv_flow_imp.id(43724015402394110)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23038778372218099)
,p_plug_template_id=>wwv_flow_imp.id(43724015402394110)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23039220121218100)
,p_plug_template_id=>wwv_flow_imp.id(43724015402394110)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23039716851218100)
,p_plug_template_id=>wwv_flow_imp.id(43724015402394110)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
